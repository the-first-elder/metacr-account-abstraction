	...
	return (
		<div className="flex justify-between items-start mt-10">
			<div className="flex flex-col w-1/2">
				...
				>
					<div className="mb-4">
						<div className="font-semibold text-lg bg-orange-300 uppercase text-white mb-4 p-2 rounded shadow-md">
							Create Address
						</div>
						<label
							htmlFor="address"
					...
					<button
						type="submit"
						className="flex bg-orange-500 text-white py-2 px-4 rounded-md justify-center items-center hover:bg-orange-600 transition-colors"
					>
						Submit
					</button>
				</form>
